...
const agents: Agent[] = [
  ...
  {
    name: "The Email Marketer",
    title: "Campaigns, Drip Sequences & List Growth",
    description:
      "Plans and executes email marketing campaigns, builds automated drip sequences, segments your list for higher open rates, and reports on what's converting. Turns your email list into your highest-ROI channel.",
    skills: [
      "Campaign strategy",
      "Drip sequences",
      "List segmentation",
    ...
    tools: ["Mailchimp", "Klaviyo", "ActiveCampaign", "Beehiiv"],
    icon: Megaphone,
