    ...
    body: JSON.stringify({
      ...
      html: `
        <div style="font-family: system-ui, -apple-system, sans-serif; max-width: 560px; margin: 0 auto;">
          ...
          <p>Please verify your email using the link below so we can review your request.</p>
          <p style="margin: 20px 0;">
            <a href="${esc(params.viewUrl)}" style="display:inline-block; background:#7c3aed; color:#fff; padding:10px 20px; border-radius:6px; text-decoration:none; font-weight:600;">Verify email &amp; view ticket</a>
          </p>
